...
class MenuScene extends Phaser.Scene {
    ...
    moveHTMLParallax(cx, cy) {
        const container = document.getElementById('ninja-form-container');
        if (container) {
            const offsetX = cx * 10;
            const offsetY = cy * 8;
    ...
    cleanupHTML() {
        ...
        // Limpiamos los elementos viejos si existen para evitar conflictos
